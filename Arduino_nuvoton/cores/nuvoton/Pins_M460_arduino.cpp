...
{
    {NULL, 0, {0, 0, 0}}, //0
    {PB, BIT5, {(uint32_t)  &SYS->GPB_MFP0, SYS_GPB_MFP1_PB5MFP_Msk,  SYS_GPB_MFP1_PB5MFP_GPIO}}, //1
    {PB, BIT4, {(uint32_t)  &SYS->GPB_MFP0, SYS_GPB_MFP1_PB4MFP_Msk,  SYS_GPB_MFP1_PB4MFP_GPIO}}, //2
    ...
    {NULL, 0, {0, 0, 0}}, //26
    {NULL, 0, {0, 0, 0}}, //27
    {PF, BIT7, {(uint32_t)  &SYS->GPF_MFP0, SYS_GPF_MFP1_PF7MFP_Msk, SYS_GPF_MFP1_PF7MFP_GPIO }}, //28
    {PF, BIT6, {(uint32_t)  &SYS->GPF_MFP0, SYS_GPF_MFP1_PF6MFP_Msk, SYS_GPF_MFP1_PF6MFP_GPIO }}, //29
    {NULL, 0, {0, 0, 0}}, //30
    {PF, BIT5, {(uint32_t)  &SYS->GPF_MFP0, SYS_GPF_MFP1_PF5MFP_Msk, SYS_GPF_MFP1_PF5MFP_GPIO }}, //31
    {PF, BIT4, {(uint32_t)  &SYS->GPF_MFP0, SYS_GPF_MFP1_PF4MFP_Msk, SYS_GPF_MFP1_PF4MFP_GPIO }}, //32
    {NULL, 0, {0, 0, 0}}, //33
    {NULL, 0, {0, 0, 0}}, //34
    {NULL, 0, {0, 0, 0}}, //35
    {NULL, 0, {0, 0, 0}}, //36
    ...
    {PE, BIT9, {(uint32_t)  &SYS->GPE_MFP2, SYS_GPE_MFP2_PE9MFP_Msk, SYS_GPE_MFP2_PE8MFP_GPIO }}, //42
    ...
    {PC, BIT7, {(uint32_t)  &SYS->GPC_MFP0, SYS_GPC_MFP1_PC7MFP_Msk, SYS_GPC_MFP1_PC7MFP_GPIO }}, //48
    {PC, BIT6, {(uint32_t)  &SYS->GPC_MFP0, SYS_GPC_MFP1_PC6MFP_Msk, SYS_GPC_MFP1_PC6MFP_GPIO }}, //49
    {PA, BIT7, {(uint32_t)  &SYS->GPA_MFP0, SYS_GPA_MFP1_PA7MFP_Msk, SYS_GPA_MFP1_PA7MFP_GPIO }}, //50
    {PA, BIT6, {(uint32_t)  &SYS->GPA_MFP0, SYS_GPA_MFP1_PA6MFP_Msk, SYS_GPA_MFP1_PA6MFP_GPIO }}, //51
    {NULL, 0, {0, 0, 0}}, //52
    {NULL, 0, {0, 0, 0}}, //53
	{NULL, 0, {0, 0, 0}}, //54
    {PA, BIT5, {(uint32_t) &SYS->GPA_MFP0, SYS_GPA_MFP1_PA5MFP_Msk, SYS_GPA_MFP1_PA5MFP_GPIO }}, //55
    {PA, BIT4, {(uint32_t) &SYS->GPA_MFP0, SYS_GPA_MFP1_PA4MFP_Msk, SYS_GPA_MFP1_PA4MFP_GPIO }}, //56
    ...
    {PC, BIT5, {(uint32_t) &SYS->GPC_MFP0, SYS_GPC_MFP1_PC5MFP_Msk, SYS_GPC_MFP1_PC5MFP_GPIO }}, //69
    {PC, BIT4, {(uint32_t) &SYS->GPC_MFP0, SYS_GPC_MFP1_PC4MFP_Msk, SYS_GPC_MFP1_PC4MFP_GPIO }}, //70
    ...
    {NULL, 0, {0, 0, 0}}, //82
    {NULL, 0, {0, 0, 0}}, //83
    {PD, BIT7, {(uint32_t) &SYS->GPD_MFP0, SYS_GPD_MFP1_PD7MFP_Msk, SYS_GPD_MFP1_PD7MFP_GPIO }}, //84
    {PD, BIT6, {(uint32_t) &SYS->GPD_MFP0, SYS_GPD_MFP1_PD6MFP_Msk, SYS_GPD_MFP1_PD6MFP_GPIO }}, //85
    {PD, BIT5, {(uint32_t) &SYS->GPD_MFP0, SYS_GPD_MFP1_PD5MFP_Msk, SYS_GPD_MFP1_PD5MFP_GPIO }}, //86
    {PD, BIT4, {(uint32_t) &SYS->GPD_MFP0, SYS_GPD_MFP1_PD4MFP_Msk, SYS_GPD_MFP1_PD4MFP_GPIO }}, //87
    ...
    {PE, BIT7, {(uint32_t) &SYS->GPE_MFP0, SYS_GPE_MFP1_PE7MFP_Msk, SYS_GPE_MFP1_PE7MFP_GPIO }}, //97
    {PE, BIT6, {(uint32_t) &SYS->GPE_MFP0, SYS_GPE_MFP1_PE6MFP_Msk, SYS_GPE_MFP1_PE6MFP_GPIO }}, //98
    {PE, BIT5, {(uint32_t) &SYS->GPE_MFP0, SYS_GPE_MFP1_PE5MFP_Msk, SYS_GPE_MFP1_PE5MFP_GPIO }}, //99
    {PE, BIT4, {(uint32_t) &SYS->GPE_MFP0, SYS_GPE_MFP1_PE4MFP_Msk, SYS_GPE_MFP1_PE4MFP_GPIO }}, //100
    ...
    {PB, BIT8,  {(uint32_t) &SYS->GPB_MFP1, SYS_GPB_MFP2_PB8MFP_Msk,  SYS_GPB_MFP2_PB8MFP_GPIO }}, //126
    {PB, BIT7,  {(uint32_t) &SYS->GPB_MFP0, SYS_GPB_MFP1_PB7MFP_Msk,  SYS_GPB_MFP1_PB7MFP_GPIO}}, //127
    {PB, BIT6,  {(uint32_t) &SYS->GPB_MFP0, SYS_GPB_MFP1_PB6MFP_Msk,  SYS_GPB_MFP1_PB6MFP_GPIO}}, //128
};
...
{
    {UART1, (uint32_t)UART1_MODULE, UART1_IRQn, {{  4, SYS_GPB_MFP0_PB2MFP_UART1_RXD }, {3, SYS_GPB_MFP0_PB3MFP_UART1_TXD }}}, //UNO uart pin

    {UART0, (uint32_t)UART0_MODULE, UART0_IRQn, {{119, SYS_GPB_MFP3_PB12MFP_UART0_RXD }, {118, SYS_GPB_MFP3_PB13MFP_UART0_TXD }}}, //ICE uart pin
};
